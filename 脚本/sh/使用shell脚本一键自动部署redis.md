本文主要介绍了shell一键部署redis的实现步骤,文中通过示例代码介绍的非常详细,对大家的学习或者工作具有一定的参考学习价值,需要的朋友们下面随着小编来一起学习学习吧！
...
function install_redis() {
    ...
    sed -ri '/^bind/s#127.0.0.1 -::1#0.0.0.0#g' $redis_config
    ...
    sed -ri '/^# requirepass/s/# requirepass foobared/requirepass 123456/' $redis_config
